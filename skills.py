...
def game():
	...
	try:
		subprocess.Popen('C:/NFS/speed.exe')
	except:
...
def work():
	'''Нужно разместить путь к exe файлу любого вашего приложения'''
	try:
		subprocess.Popen("C:/Program Files/JetBrains/PyCharm Community Edition 2022.2.3/bin/pycharm64.exe")
	except:
		voice.speaker('Путь к файлу не найден, проверьте, правильный ли он')
...
def weather():
	...
	try:
		params = {'q': 'Colombo', 'units': 'metric', 'lang': 'ru', 'appid': '4a50f5cb8706a4564dae13d81c3268fe'}
